...
<body>
	...
	<div class="col-md-6 mx-auto">
		<div class="card">
			<div class="card-body">
			<h4 class="text-center">Add  Knowledge Area</h4>
			<br>
				<form action="PlanController" method="POST">				
					...
					<div>
						<button name = "addKnowledgeArea" type="submit" class="btn btn-success btn-block">Add Knowledge Area</button>
					</div>
				</form>
			</div>
		</div>
	...
	<br>
	<%ArrayList KnowledgeAreaList = (ArrayList) request.getAttribute("listPlanWithKnowledgeArea");%>
	<div class="col-md-6 mx-auto">
		<div class="card">
			<div class="card-body">
				<form action="PlanController" method="POST">
					<div>
						<button name = "allKnowledgeArea" type="submit" class="btn btn-outline-secondary btn-block">Show all Knowledge Areas</button>
					</div>
					<br>
